...
export const BlogCard = ({ post, className }: BlogCardProps) => {
  ...
  return (
    <Link to={`/blog/${post.slug}`} className="block">
      <Card className={`overflow-hidden hover:shadow-lg transition-all duration-300 group cursor-pointer h-[550px] flex flex-col hover:scale-105 ${className}`}>
        ...
        <CardHeader className="flex-1 flex flex-col">
          ...
          <CardDescription className="text-sm text-muted-foreground font-inter flex-1 overflow-hidden text-ellipsis" style={{
            display: '-webkit-box',
            WebkitLineClamp: 4,
