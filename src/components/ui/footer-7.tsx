        ...
        <div className="flex w-full flex-col justify-between gap-10 lg:flex-row lg:items-start lg:text-left">
          <div className="flex w-full flex-col justify-between gap-6 lg:items-start">
            ...
            <ul className="flex items-center space-x-6 text-muted-foreground">
              {socialLinks.map((social, idx) => <li key={idx} className="font-medium hover:text-primary">
          ...
          <div className="grid w-full gap-6 md:grid-cols-3 lg:gap-20">
            {sections.map((section, sectionIdx) => <div key={sectionIdx}>
                ...
                <ul className="space-y-3 text-xs text-muted-foreground">
                  {section.links.map((link, linkIdx) => <li key={linkIdx} className="font-medium hover:text-primary">
