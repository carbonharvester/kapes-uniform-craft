        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-2 flex-col">
            ...
            <p className="text-lg max-w-xl lg:max-w-xl leading-relaxed tracking-tight text-muted-foreground">
              See the transformation from traditional uniform distribution to our modern solution.
            </p>
          </div>
          <div className="pt-12 w-full">
            ...
            >
              ...
              />
              <img
                src="https://res.cloudinary.com/dng12bd0a/image/upload/v1753038512/WhatsApp_Image_2025-07-20_at_20.04.16_ssfyrw.jpg"
                alt="Traditional uniform distribution"
