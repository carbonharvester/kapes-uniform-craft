    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto p-5 bg-card rounded-lg shadow-lg" ref={formRef}>
          ...
          <div>
            ...
            <div className="flex justify-between mt-5">
              <Button
                onClick={handlePrev}
                variant="secondary"
                className={`${currentSlide === 0 ? 'hidden' : 'inline-block'}`}
              >
        ...
        {showImprove && (
          <Card className="mt-8">
            <CardHeader>
              <CardTitle>Improve Your Sustainability</CardTitle>
            </CardHeader>
            <CardContent>
              <h2 className="text-xl mb-4">Do you want to improve the sustainability of your school uniforms?</h2>
        ...
        {showFeatures && (
          <Card className="mt-8">
            <CardHeader>
              <CardTitle>Select Priorities</CardTitle>
            </CardHeader>
            <CardContent>
              <h2 className="text-xl mb-4">Select what's important to you:</h2>
            ...
            <CardContent className="text-center">
              ...
              {userFeatures.length > 0 && (
                <div className="mb-6 p-4 bg-background rounded-lg">
                  <h3 className="text-xl mb-3">You Qualify for a Free Consultation!</h3>
