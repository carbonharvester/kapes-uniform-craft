              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Qualify for a one-on-one session with Kapes Uniforms Founder, Matthew Benjamin, to implement changes</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Just 3 minutes for insights that save money, reduce waste, and enhance reputation</p>
                  </div>
                </div>
              </div>
