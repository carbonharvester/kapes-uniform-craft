  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-24 bg-gradient-primary text-white overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-32 h-32 bg-white/5 rounded-full blur-3xl"></div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            <div className="group hover-lift animate-fade-in">
              <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-8 h-full border shadow-glass hover:shadow-glow transition-all duration-500">
                ...
                <div className="bg-green-500/10 rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-green-600 dark:text-green-400">This Year</span>
                    <TrendingUp className="w-4 h-4 text-green-600" />
                  </div>
                  <div className="text-2xl font-bold text-green-700 dark:text-green-300">2.4 tonnes CO₂</div>
                  <div className="text-xs text-green-600 dark:text-green-400">Saved vs. traditional uniforms</div>
                </div>
              </div>
            </div>

            <div className="group hover-lift animate-fade-in" style={{ animationDelay: '0.1s' }}>
              <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-8 h-full border shadow-glass hover:shadow-glow transition-all duration-500">
                ...
                <div className="bg-blue-500/10 rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-blue-600 dark:text-blue-400">Garments Recycled</span>
                    <Award className="w-4 h-4 text-blue-600" />
                  </div>
                  <div className="text-2xl font-bold text-blue-700 dark:text-blue-300">1,247 items</div>
                  <div className="text-xs text-blue-600 dark:text-blue-400">Diverted from landfill</div>
                </div>
              </div>
            </div>

            <div className="group hover-lift animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-8 h-full border shadow-glass hover:shadow-glow transition-all duration-500">
                ...
                <div className="bg-orange-500/10 rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-orange-600 dark:text-orange-400">Meals Provided</span>
                    <Heart className="w-4 h-4 text-orange-600" />
                  </div>
                  <div className="text-2xl font-bold text-orange-700 dark:text-orange-300">3,741 meals</div>
      ...
      <section className="py-24 bg-secondary/10 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-5xl mx-auto text-center animate-fade-in">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 heading-gradient">QR Codes for Instant Transparency</h2>
            
            <div className="bg-card/80 backdrop-blur-sm rounded-3xl p-8 shadow-glass hover-lift">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="flex justify-center">
                  <div className="bg-card rounded-2xl p-8 shadow-soft border">
                    <div className="w-32 h-32 bg-gradient-secondary rounded-lg flex items-center justify-center">
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-3xl p-8 border shadow-glass hover-lift">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-card/50 rounded-xl p-6 border shadow-soft hover-lift">
