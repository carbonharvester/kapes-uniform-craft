        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {trackingMetrics.map((metric, index) => (
              <div key={index} className="group hover-lift transition-smooth animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="border-0 shadow-glass rounded-3xl p-8 h-full">
                  ...
                  <div className={`bg-${metric.color}-500/10 rounded-xl p-4`}>
                    ...
                    <div className={`text-xs text-${metric.color}-600 dark:text-${metric.color}-400`}>
                      {metric.color === 'green' ? 'Saved vs. traditional uniforms' : 
                       metric.color === 'blue' ? 'Diverted from landfill' : 
                       'To children in need'}
                    </div>
                  </div>
                </div>
